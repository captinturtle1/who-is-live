export default function AddRemove({setIsHelpOpen}) {
  return (
    <div className="fixed left-0 right-0 top-0 bottom-0 flex gap-8 bg-black backdrop-blur bg-opacity-10 text-white p-16">
      <div className="flex flex-col gap-4 bg-slate-600 rounded m-auto p-16 max-w-[800px]">
